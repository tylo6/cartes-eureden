...
import { MessageContentDetail, MessageContent, ChatMessage, ToolMetadata } from '../../llms/dist/index.cjs';
...
declare function blobToDataUrl(input: Blob): Promise<string>;
...
declare function assertIsJSONValue(value: unknown): asserts value is JSONValue;
