...
declare const DEFAULT_EU_BASE_URL = "https://api.cloud.eu.llamaindex.ai";
...
export type { JSONArray, JSONObject, JSONValue, LLMEndEvent, LLMStartEvent, LLMStreamEvent, LLMToolCallEvent, LLMToolResultEvent, LlamaIndexEventMaps, UUID };
