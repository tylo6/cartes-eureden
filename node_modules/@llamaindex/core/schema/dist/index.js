...
import { Settings, DEFAULT_CHUNK_OVERLAP, DEFAULT_CHUNK_SIZE } from '../../global/dist/index.js';
...
const agentParamsSchema = z.array(baseToolWithCallSchema);
const sentenceSplitterSchema = z.object({
    ...
    extraAbbreviations: z.array(z.string(), {
