 ...
 */ class ContextChatEngine extends index_cjs.PromptMixin {
    ...
    constructor(init){
        ...
        this.memory = init?.chatHistory instanceof index_cjs$5.Memory ? init.chatHistory : index_cjs$5.createMemory(init?.chatHistory ?? []);
    ...
    async chat(params) {
        ...
        const chatHistory = params.chatHistory ? params.chatHistory instanceof index_cjs$5.Memory ? params.chatHistory : index_cjs$5.createMemory(params.chatHistory) : this.memory;
 ...
 */ class SimpleChatEngine {
    ...
    constructor(init){
        ...
        this.memory = init?.memory ?? index_cjs$5.createMemory();
    }
    async chat(params) {
        const { message, stream } = params;
        const chatHistory = params.chatHistory ? params.chatHistory instanceof index_cjs$5.Memory ? params.chatHistory : index_cjs$5.createMemory(params.chatHistory) : this.memory;
