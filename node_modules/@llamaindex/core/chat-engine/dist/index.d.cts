...
import { Memory } from '../../memory/dist/index.cjs';
...
declare class SimpleChatEngine implements BaseChatEngine {
    memory: Memory;
    llm: LLM;
    get chatHistory(): Promise<___llms.ChatMessage[]>;
...
export type { BaseChatEngineParams, ContextChatEngineOptions, NonStreamingChatEngineParams, StreamingChatEngineParams };
