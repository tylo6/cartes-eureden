...
import { IndexStruct } from '../../../data-structs/dist/index.js';
import { BaseKVStore, BaseInMemoryKVStore, DataType } from '../../kv-store/dist/index.js';
...
declare class SimpleIndexStore extends KVIndexStore {
    ...
    static fromPersistDir(persistDir?: string, options?: {
        logger?: Logger;
    }): Promise<SimpleIndexStore>;
    static fromPersistPath(persistPath: string, options?: {
        logger?: Logger;
    }): Promise<SimpleIndexStore>;
    persist(persistPath?: string): Promise<void>;
