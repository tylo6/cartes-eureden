...
class SimpleIndexStore extends KVIndexStore {
    ...
    static async fromPersistDir(persistDir = index_cjs.DEFAULT_PERSIST_DIR, options) {
    ...
    static async fromPersistPath(persistPath, options) {
        const simpleKVStore = await index_cjs$2.SimpleKVStore.fromPersistPath(persistPath, options);
