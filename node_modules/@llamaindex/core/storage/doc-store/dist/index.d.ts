import { StoredValue, ObjectType, BaseNode } from '../../../schema/dist/index.js';
import { Logger } from '@llamaindex/env';
import { BaseKVStore } from '../../kv-store/dist/index.js';
...
declare class KVDocumentStore extends BaseDocumentStore {
    ...
    private logger;
    constructor(kvstore: BaseKVStore, namespace?: string, options?: {
        logger?: Logger;
    });
...
export type { RefDocInfo, Serializer };
