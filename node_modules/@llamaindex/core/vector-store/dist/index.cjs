...
function metadataDictToNode(metadata, options) {
    ...
    switch(nodeType){
        case "IndexNode":
            return index_cjs.jsonToNode(nodeObj, index_cjs.ObjectType.INDEX);
        default:
            return index_cjs.jsonToNode(nodeObj, index_cjs.ObjectType.TEXT);
    }
}
...
class BaseVectorStore {
    constructor(params){
        this.embedModel = params?.embedModel ?? params?.embeddingModel ?? index_cjs$1.Settings.embedModel;
    }
}
...
exports.VectorStoreQueryMode = VectorStoreQueryMode;
exports.escapeLikeString = escapeLikeString;
exports.metadataDictToNode = metadataDictToNode;
exports.nodeToMetadata = nodeToMetadata;
...
exports.validateIsFlat = validateIsFlat;
