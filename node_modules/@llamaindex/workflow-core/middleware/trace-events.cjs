...
function getEventOrigins(eventData, context = (0, __llamaindex_workflow_core.getContext)()) {
		...
		createContext() {
			...
			context.__internal__call_context.subscribe((handlerContext, next) => {
				...
				handlerMiddleware = (...args) => {
					...
					if (require_utils.isPromiseLike(result)) return result.then((result$1) => {
...
exports.getEventOrigins = getEventOrigins;
exports.runOnce = runOnce;
exports.withTraceEvents = withTraceEvents;
//# sourceMappingURL=trace-events.cjs.map